%copyright by MOHAMMAD
%Update 10 ABAN 1398

\newcommand{\beamerTextColor}[1]{\setbeamercolor{normal text}{fg=#1}\usebeamercolor*{normal text}}
\newcommand{\beamerThemeColor}[1]{\usecolortheme[named=#1]{structure}}
\newcommand{\beamerBackGroundImage}[1]{
